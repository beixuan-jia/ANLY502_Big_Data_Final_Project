...
The dataset used for this project is the news archived in 2016 from the GDELT 2.0 Event Database, which has 58 features and 73,385,698 records. The dataset contains 57 feature columns, of which 50 features are qualitative variables and 7 are quantitative variables, and 1 target variable AvgTone, which is a score indicating the tone of the event. Key columns and descriptions are described as follow: 
...
●	QuadClass. (integer) The entire CAMEO event taxonomy is ultimately organized under four primary classifications: 1=Verbal Cooperation, 2=Material Cooperation, 3=Verbal Conflict, and Material Conflict.
...
Although this project focuses mainly on the analysis of news in 2016, a few news from 2006, 2007, and 2015 also included in the dataset. The following table, Table 3.1.1, demonstrates that the average tones for all the years are all slightly negative. 
...
The barplot in Fig 3.1.1 shows the overall trend of global news in 2016 sorted by average tone. We can see that most countries’ average tones fall into the range between -5 to 2, and only about 25 among 220 countries have news whose avgtones are positive. The average tones for most countries’ news’ are slightly negative. 
